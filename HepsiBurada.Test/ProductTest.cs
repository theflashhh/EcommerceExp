...
namespace HepsiBurada.Test
{
    public class ProductTest
    {
        ...
        [Theory]
        [InlineData("create_product P1 100 1000", "Product created; code P1, price 100, stock 100")]
        ...
        [Theory]
        [InlineData("create_product P1 100 1000", "get_product_info P1",
